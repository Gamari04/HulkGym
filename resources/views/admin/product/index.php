...
<head>
    ...
    <link rel="stylesheet" href="https://cdn.lordicon.com/skkahier.json">
    <link rel="stylesheet" href="https://cdn.lordicon.com/ylvuooxd.json">
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content bg-secondary text-light">
                        ...
                        <div class="modal-body">
                            <form action="{{ route('products.store') }}" method="post" enctype="multipart/form-data" class="shadow p-4 rounded mt-5" style="width: 90%; max-width: 50rem;">
                                @csrf
                                <h1 class="text-center pb-5 display-4 fs-3">Add New Product</h1>

                                <div class="mb-3">
                                    <label class="form-label">Name</label>
                                    <input type="text" class="form-control border text-dark" placeholder="Enter a title" name="name">
                                    
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Description</label>
                                    <input type="text" class="form-control border text-dark" placeholder="Enter a title" name="description">
                                    
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Price</label>
                                    <input type="text" class="form-control border text-dark" placeholder="Enter a title" name="price">
