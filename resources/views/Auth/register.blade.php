	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form  method="post"  class="login100-form " action="{{ route('register') }}" enctype="multipart/form-data">
				@csrf	
				<span class="login100-form-title">
					...
					<div class="container-login100-form-btn">
						<button class="login100-form-btn" style="background-color: rgb(42,128,0);">
							Login
						</button>
					</div>
				...
				<div class="login100-pic js-tilt" data-tilt>
					<img src="images/hulk.png" alt="IMG" >
				</div>
			</div>
		</div>
	</div>
